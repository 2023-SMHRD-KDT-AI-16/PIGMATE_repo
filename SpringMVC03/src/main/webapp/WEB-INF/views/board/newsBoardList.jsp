  ...
  <script type="text/javascript">
    ...
    function makeView(newsList, pageMaker) {
      ...
      $.each(newsList, function (index, obj) {
        ...
        var imageUrl = obj.image_url ? obj.image_url : '${pageContext.request.contextPath}/resources/img/default-image.jpg';
        var contentPreview = obj.news_content ? obj.news_content.replace(/<\/?[^>]+(>|$)/g, "").replace(/[\r\n]/g, "").substring(0, 150) + "..." : ""; // 글자수 150자로 제한, HTML 태그 제거
        ...
        listHtml += "<p class='news-content'>" + contentPreview + "</p>";
    ...
    function makePagination(pageMaker) {
      ...
      if (pageMaker.prev) {
        paginationHtml += "<li class='page-item'><a class='page-link' href='javascript:void(0);' onclick='newsList(" + (pageMaker.startPage - 1) + ")'>Previous</a></li>";
      }
