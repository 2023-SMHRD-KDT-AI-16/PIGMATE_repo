            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="#" aria-expanded="false">
                        ...
                        <span class="hide-menu">돼지정보</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="#" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="${pageContext.request.contextPath }/newsList.do" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="${pageContext.request.contextPath }/myPage.do" aria-expanded="false">
